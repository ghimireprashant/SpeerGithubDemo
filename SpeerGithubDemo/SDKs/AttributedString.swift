...
public class AttributedString {
  ...
  @discardableResult public func text(_ string: String, attributes: [Attribute] = []) -> AttributedString {
  ...
  @discardableResult public func attributedText(_ attributedString: NSAttributedString) -> AttributedString {
    
    masterAttributedString.append(attributedString)
    return self
  }
  
  @discardableResult public func spaces(_ number: Int, attributes: [Attribute] = []) -> AttributedString {
  ...
  @discardableResult public func space(attributes: [Attribute] = []) -> AttributedString {
    return text(" ", attributes: attributes)
  }
  
  @discardableResult public func newlines(_ number: Int, attributes: [Attribute] = []) -> AttributedString {
  ...
  @discardableResult public func newline(attributes: [Attribute] = []) -> AttributedString {
    return text("\n", attributes: attributes)
  }
  
  @discardableResult public func tabs(_ number: Int, attributes: [Attribute] = []) -> AttributedString {
  ...
  @discardableResult public func tab(attributes: [Attribute] = []) -> AttributedString {
    return text("\t", attributes: attributes)
  }
  
  // MARK: - Images
  
  @discardableResult public func image(_ anImage: UIImage) -> AttributedString {
  ...
  @discardableResult public func image(_ anImage: UIImage, width: CGFloat) -> AttributedString {
  ...
  @discardableResult public func image(_ anImage: UIImage, height: CGFloat) -> AttributedString {
  ...
  @discardableResult public func image(_ anImage: UIImage, size: CGSize) -> AttributedString {
  ...
  @discardableResult public func image(_ anImage: UIImage, withSizeFittingFontUppercase font: UIFont) -> AttributedString {
    
    let height = font.capHeight
    return image(anImage, height: height)
  }
  
  @discardableResult public func image(_ anImage: UIImage, withSizeFittingFontLowercase font: UIFont) -> AttributedString {
